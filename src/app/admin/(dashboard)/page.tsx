  ...
  return (
    <>
      ...
      {!isMailConfigured(mail) ? (
        <div className="mt-6 border-l-2 border-burgundy bg-paper p-5">
          ...
          <p className="mt-1.5 text-sm text-stone">
            ...
            <Link href="/admin/settings#mail" className="link-underline text-green">
              Settings → Email
            </Link>
            .
          </p>
      ...
      <div className="mt-8 grid gap-4 sm:grid-cols-2">
        <Link
          ...
          className="border border-paper-edge bg-paper p-6 transition-colors hover:border-green"
        >
          <p className="eyebrow">Enquiries</p>
          <p className="mt-3 font-display text-[2.25rem] leading-none text-burgundy">
            {newCount}
          </p>
