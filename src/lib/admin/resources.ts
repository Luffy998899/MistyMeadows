...
export const RESOURCES: Resource[] = [
  {
    ...
    fields: [
      ...
      { name: "image_id", label: "Main photograph", type: "media" },
      {
        ...
        label: "Room video",
        type: "media",
        help: "Optional walkthrough. Upload an MP4 or WebM — it plays on the room page.",
      },
      {
        name: "summary",
        label: "Short summary",
      ...
      {
        name: "rate_inr",
        label: "Nightly rate before GST (₹)",
        type: "number",
        min: 0,
        help: "Enter the tariff WITHOUT tax. Leave blank to show “Rates on request”.",
      },
      {
        name: "gst_percent",
        label: "GST %",
        ...
        min: 0,
        max: 100,
        help: "The website adds this to the rate above and shows the total, so you never calculate it yourself. Leave blank to display “+ applicable taxes” instead.",
      },
  ...
  },
  {
    ...
    fields: [
      ...
      {
        name: "rate_monthly_inr",
        label: "Monthly rate before GST (₹)",
        type: "number",
        min: 0,
        help: "Enter the rent WITHOUT tax.",
      },
      {
        name: "gst_percent",
        label: "GST %",
        ...
        min: 0,
        max: 100,
        help: "Added automatically for display. Leave blank to show “+ applicable taxes”.",
      },
