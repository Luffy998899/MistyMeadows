...
-- in. Re-running this file is safe (it upserts on natural keys).
-- =====================================================================
...
update public.site_settings set
  ...
  socials       = '{"facebook": "", "instagram": "", "twitter": "", "youtube": ""}'::jsonb,
...
insert into public.apartments (name, block, detail, rate_monthly_inr, sort_order) values
...
insert into public.facilities (category, name, description, icon, sort_order) values
...
insert into public.dining_items (category, name, detail, price_note, sort_order) values
  ('thali', 'Veg Thali',
   'Dal makhani, mix vegetable, rice, salad, roti, raita',
   '350 + GST per thali', 1),
  ('thali', 'Non-Veg Thali',
   'Murg makhani, mix vegetable, rice, salad, roti, raita',
   '450 + GST per thali', 2),
  ('picnic', 'Day Picnic — Vegetarian',
   'Day picnic package, per person',
   '1600 + tax', 3),
  ('picnic', 'Day Picnic — Non-Vegetarian',
   'Day picnic package, per person',
   '2100 + tax', 4)
on conflict do nothing;
...
insert into public.testimonials (author, headline, quote, rating, sort_order) values
